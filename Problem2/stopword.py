...
def store_stop_trie(stop_trie):
    ...
    stop_clean = open("Problem2/texts/stopwords_clean.txt", "r", encoding="utf8")
...
def filter_stop_words(file_name, stop_trie):
    file2 = open("Problem2/texts/" + file_name + ".txt", "r", encoding="utf8")
    ...
    file2 = open("Problem2/texts/" + file_name + ".txt", "w", encoding="utf8")
